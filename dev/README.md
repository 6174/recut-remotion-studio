...
2026-08-09-canvas-ui-effect-adapter-study.md: CanvasUI Bubble/Magnify/Glitch/Peel 源码研究；定义 effect-specific fixture、adapter 边界、确定性替换与性能改造顺序。

此目录保存 Remotion Studio 的可追溯设计记录，不参与 App 运行时；镜头层以 CanvasUI effect adapter 研究为准，旧的万能 GPU 合成器计划仅保留为问题沿革。
