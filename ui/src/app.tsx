  ...
  return (
    <div className="app">
      ...
      {!brief ? (
        ...
        <Studio assets={assets} brief={brief} catalog={catalog} mediaMap={mediaMap} onRedesign={() => void redesign()} setStatus={setStatus} />
      )}
    </div>
  );
}
