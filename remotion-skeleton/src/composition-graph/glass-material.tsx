 ...
 * [OUTPUT]: 对外提供 HtmlGlassMaterial，以 CanvasUI Glass 的原始 SDF、色散、折射与 GGX 计算渲染 HTML texture
 * [POS]: composition-graph 的 Effect Node；以 CanvasUI circle glass 参数为基准，仅适配 Three 的 UV 与不透明底图混合
...
// CanvasUI Glass FRAG, retaining the optical model and adapting its transparent overlay to our source plane.
