import{j as u,r as Tr,c as Mr}from"./client-DOSV_kvz.js";import{r as j,d as Wr,c as Gr,a as qr,u as ot,b as lt,e as Zr,A as Xr,P as Yr}from"./index-tOGda-a7.js";import{V as te,U as R,C as Xn,D as Kr,u as Qn,a as er,S as tr,b as Jr,L as wr,T as Qr}from"./index-BfslqXIw.js";const Yn=24,kr=18,eo=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
`,uo=({bend:s,texture:c})=>{const h=j.useRef(null),y=j.useMemo(()=>({uMap:new R(c),uBend:new R(s)}),[c]);return j.useLayoutEffect(()=>{h.current&&(h.current.uniforms.uBend.value=s)},[s]),u.jsx("shaderMaterial",{ref:h,fragmentShader:ao,side:Kr,toneMapped:!1,uniforms:y,vertexShader:io})},co=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
