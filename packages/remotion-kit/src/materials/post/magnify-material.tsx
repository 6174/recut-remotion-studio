 ...
 * [OUTPUT]: 对外提供 HtmlMagnifyMaterial，以放大镜的像素 HUD、AA、haze 与 chromatic aberration 渲染内容纹理
 * [POS]: remotion-kit/src/materials 的 post Effect Node；保留光学计算，仅适配 Three UV
