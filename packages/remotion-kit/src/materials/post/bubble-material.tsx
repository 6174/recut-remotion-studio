 ...
 * [OUTPUT]: 对外提供 HtmlBubbleMaterial，以 metaball trail ray-march、折射、色散和 glints 渲染内容纹理
 * [POS]: remotion-kit/src/materials 的 post Effect Node；轨迹由可 seek 的时间函数重建，无鼠标历史依赖
